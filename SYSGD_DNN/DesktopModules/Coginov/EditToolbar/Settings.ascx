<%@ Control Language="C#" AutoEventWireup="false" Inherits="Coginov.Modules.TestEmployeurs.Settings" Codebehind="Settings.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="TestEmployeurs Settings Design Table">
    <tr>
