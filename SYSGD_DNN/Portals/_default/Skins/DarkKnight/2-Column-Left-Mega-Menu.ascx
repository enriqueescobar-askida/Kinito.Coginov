  ...
  <div id="Background"></div>
        ...
        <div id="Panes">
		    <div id="LogoRow">
                ...
                <div class="LogoRowRight">
                    <div id="Login"><dnn:LOGIN ID="LOGIN1" CssClass="LoginLink" runat="server" />|
                    <dnn:USER ID="USER1" runat="server" />
					<%--<dnn:LANGUAGE runat="server" id="dnnLANGUAGE"  showMenu="False" showLinks="True" />--%> </div>
			        <div id="CurrentEntityPane" runat="server" ></div>
                </div>
		    </div>
	...
	<div id="Footer">
        <div class="Content">
            ...
            <div id="Copyright"><dnn:COPYRIGHT ID="dnnCopyright" runat="server" />
