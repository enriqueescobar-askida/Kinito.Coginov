...
<head>
    ...
    <title runat="server" id="Title">Erreur</title>
        ...
        <table cellspacing="5" cellpadding="5" border="0" class="Error">
	        ...
	        <tr style="height:100%;">
		        <td valign="top" style="width:650px;">
                    <h2>Erreur de SYSGD</h2>
                    <hr />
                    <p><asp:PlaceHolder ID="ErrorPlaceHolder" runat="server" /></p>
                </td>
	        </tr>
	        <tr>
	            <td align="right"><asp:Hyperlink ID="hypReturn" runat="Server" NavigateUrl="~/Default.aspx" cssClass="WizardButton" text="Retour"/></td>
	        </tr>
