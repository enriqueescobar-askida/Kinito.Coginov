...
dnn.controls.control.prototype = 
{
    ...
    //strips prefix of on from event name
...
dnn.controls.DNNCallbackEventArgs.registerClass('dnn.controls.DNNCallbackEventArgs', Sys.EventArgs);

//allows onsubmit to be easily trapped
